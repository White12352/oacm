...
#sed -i 's/192.168.0.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.2.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.3.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.4.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.5.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.6.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.7.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.8.1/192.168.5.6/g' package/base-files/files/bin/config_generate
#sed -i 's/192.168.9.1/192.168.5.6/g' package/base-files/files/bin/config_generate
